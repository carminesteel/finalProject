...
<body>
   ...
   <form name="frm" action="/login/insert" method="post" id="myForm"   enctype="multipart/form-data">
         ...
         <div id=id_row>            
            ...
            <input class="form-control" type="text" class="box" placeholder="ID" name="id" value="" required>         
            <div id="idOk"   class="idid" style="color:blue;">사용 가능한 아이디 입니다.</div>
         ...
         <div>
            ...
            <input class="form-control" type="text" class="box" placeholder="Name" name="name" value="" required>
         </div>
         
         <!--닉네임-->
         <div>
         	<h5 style="text-align:left;margin-left:100px;">닉네임</h5>            
            <input class="form-control" type="text" class="box" placeholder="NickName" value=""   name="nickname" required>
         </div>
         
         <!--휴대전화-->
         <div>
         	<h5 style="text-align:left;margin-left:100px;">휴대전화 ('-' 없이 번호만 입력해주세요)</h5> 
            <input class="form-control" type="text" class="box" placeholder="TEL" value=""   name="phone" required>
         </div>               
         ...
         <div id="email_row">
               ...
               <input class="form-controlE" type="text" name="email" id="email" placeholder="email" value="${emali}"> 
               <input class="form-controlEB" type="button" id="sendMessage" value="인증번호 받기" style="margin-bottom:10px;">
         ...
         <div id="chkEmail" style="display:none">
            ...
            <input class="form-controlE" type="text" name="email_injeung" placeholder="인증번호를 입력하세요.">
            <button style="width:99.9px; outline:none; background:#2e6cb5;color:#fff;height:30px;border:none;border-radius:6px 6px 6px 6px;margin-bottom:0px; margin-bottom:10px;" name="email_injeung_btn">확인</button>
         ...
         <div>
            ...
            <div><textarea  name="introduce" value="${introduce}" placeholder="자기를 소개하는 글을 쓰세요"
            style="resize:none; width:330px; height:100px;"></textarea></div>
         </div>
         
         <!--우편번호 찾기-->
         <div>
            <input type="button" id="form-controlAB" onclick="openAddress();" value="우편번호 찾기" 
            style="">
         </div>
         <div>
         ...
         <div>
            <div><input class="form-control" type="text" name="roadAddress" class="box" value="${roadAddress}"
               id="users_address" placeholder="도로명주소" required></div>
         </div>
         <div>
            <div><input class="form-control" type="text" name="jibunAddress" class="box" value="${jibunAddress}"
               id="users_addressDetail" placeholder="상세주소" required></div>
         </div>
         <div>
            <div><input class="form-control" type="text" name="addr" class="box" value="${addr}"
