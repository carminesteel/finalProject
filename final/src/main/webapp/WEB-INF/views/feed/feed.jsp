...
<style>
	#tbl{overflow:hidden;width:500px;}
	#tbl .row{}
</style>
<body>
...
<h1>Feed</h1>
	<div id=tbl border=1 >
		<c:forEach items="${Flist}" var="fvo">
			<table class=ftbl>
					<tr>
						<td colspan=2><img src="../display?fileName=${fvo.image}" width=400 height=400></td>
					</tr>
					<tr>
						<td width=45><img src="../display?fileName=${fvo.u_image}" width=40 height=40></td>
