			...
			<div style="width: 1100px;margin: auto;">
					<div>
						<table style="text-align: center; border-collapse: collapse; border: none">
								<tr style="background: #2b4163; border-top: #373e45; border-bottom: #373e45; height: 35px; color: white;">
							...
							<c:forEach items="${clist}" var="cvo">
									...
									<tr class=row>										
										<td width=175 width=150 style="padding: 15px;"><img
						...
						<span style="margin-left:1000px;">배송비 : ${shipping_fee}</span>
					...
					<div
						style="display: inline-block; float: left; width: 800px; margin: 30px;">
